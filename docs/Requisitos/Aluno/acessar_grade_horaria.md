...
2. Ao logar, o usuário é encaminhado para a página inicial e, para acessar os horários de sua disciplina, clica no botão com o ícone de “Disciplina” na parte inferior da tela; <!-- Interação do sistema -->
3. Caso esteja em outra sessão, Aluno navega até a parte inferior da tela e seleciona a opção “Disciplina” (com um ícone de Livros). <!-- Interface do usuário -->
...
2.1. Caso não consiga clicar no ícone, o usuário pode entrar na aba de opções (acessada pelo ícone com o nome de “configurações”) e acessar a linha que informa “Disciplinas”. <!-- Interação do sistema -->